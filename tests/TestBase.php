    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('files', [
                ...
                'model_types' => [
                    ...
                    'video-youtube'    => 'Reactor\Documents\Media\YoutubeVideo',
                    'video-vimeo'      => 'Reactor\Documents\Media\VimeoVideo',
                    'audio-soundcloud' => 'Reactor\Documents\Media\SoundcloudAudio',
                ]]
        );
    }
